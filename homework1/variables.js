...
const userName = ""; //имя (постоянное), тип переменной - строка
const userSurname = ""; //фамилия (постоянное), тип переменной - строка
let userAge = 0; //возраст (может изменяться), тип переменной - число
let userInfo = ""; //информация о пользователе ( может изменяться), тип переменной - строка
